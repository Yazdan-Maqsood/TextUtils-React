    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.Theme} bg-${props.Theme}`}>
        <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div className={`form-check form-switch text-${props.Theme === "light" ? "dark" : "light"} mx-3`}>
                    <label className="form-check-label mx-2" htmlFor="flexSwitchCheckDefault">{props.themeName}</label>
